...
<strong>Step 1: Submit details | <span class="style2">Step 2: </span></strong>
<span class="style2"><strong>Make payment to complete your subscription</strong></span>
<p>Fill in this form to set up your account with Magistrates Cases: </p>
...
<tr>
  ...
  <td><input type="password" name="password" />
    *{if isset($customerform_errors.password)}<div class="alert">{$customerform_errors.password}</div>{/if}</td></tr>
<tr>
  <td><div align="right">Confirm Password </div></td>
  <td><input type="password" name="confirmpassword" />
    *{if isset($customerform_errors.confirmpassword)}<div class="alert">{$customerform_errors.confirmpassword}</div>{/if}</td></tr>
